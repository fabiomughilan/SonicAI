    ...
    def register_actions(self) -> None:
        self.actions = {
            ...
            "deploy-nft": Action(
                name="deploy-nft",
                parameters=[
                    ActionParameter("name", True, str, "NFT name"),
                    ActionParameter("symbol", True, str, "NFT symbol"),
                    ActionParameter("base_uri", True, str, "Base URI for NFT metadata")
                ],
                description="Deploy an NFT contract"
            )
        }
