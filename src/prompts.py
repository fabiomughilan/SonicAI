...
#Farcaster prompts
REPLY_CAST_PROMPT = ("Generate a friendly, engaging reply to this cast: {cast_text}. Keep it under 280 characters. Don't include any hashtags, links or emojis.")

POST_CAST_PROMPT = ("Generate an engaging tweet. Don't include any hashtags, links.Include emojis. Keep it under 150 characters."
                      "The tweets should be pure commentary, Should shill any coins or projects apart from {agent_name}. Do not repeat any of the casts that were given as the examples and generate new casts. Avoid the words AI and crypto.")

MEME_PROMPT = ("Generate a meme related to DWF labs Portfolio and Sonic . The meme should be engaging and humorous. Avoid using any brand names or logos. "
               "The meme should be relevant to the current trends in the crypto space. Keep it light-hearted and fun. Avoid controversial or sensitive topics.Keep it under 100 characters.")